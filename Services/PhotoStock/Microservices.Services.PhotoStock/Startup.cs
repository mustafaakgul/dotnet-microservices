...
namespace Microservices.Services.PhotoStock
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddControllers(); controllerlara komple authorize tek tek vermektense buraya verip hepsine toplu veriyoruz
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseStaticFiles();  //photos dosyalarına dısardan public olarak eirşim vermek
            app.UseRouting();
