...
//burada postgresql baglandı normalde discount icin nosql daha uygujn veri yapısı tablosu model tam belli olmadngnda veya hızdan felan
namespace Microservices.Services.Discount.Services
{
    public class DiscountService : IDiscountService
    {
        ...
        public async Task<Response<NoContent>> Save(Models.Discount discount)
        {
            ...
            return Response<NoContent>.Fail("an error occurred while adding", 500);  //server kaynaklı hata oldugunda, ayrıca bir cok exception olusablir burda hata oldu ve olmadı diye ayırmakta mantıklı
        }
